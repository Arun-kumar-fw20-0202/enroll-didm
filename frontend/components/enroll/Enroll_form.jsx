          ...
          <div className="w-[60%]">
            <div className="flex flex-col justify-start bg-full w-full px-10">
              ...
              <p className="text-[14px]">
                ...
                regulations of Delhi Institute of Digital Marketing. By filling
                up this form, I certify that to the best of my knowledge and
                belief, the information provided in this application form is
                true and complete.
              </p>
            </div>
            <div className="flex justify-start w-full px-10 my-5">
              <Checkbox
                ...
                defaultSelected
              >
                By clicking Agree Button, you agree to the Terms and Conditions
