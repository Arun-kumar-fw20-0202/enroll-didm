...
export const Enroll_form = () => {
  return (
    <div className="mt-16">
      ...
      <Enroll_heading />
      {/* form  */}
      <div className="border-gray-400 mt-10 pb-10 rounded-md border-1 my-4 large:mx-28 medium:mx-22 small:mx-18 base:mx-2 relative flex flex-col items-center justify-center">
        {/* heading  */}
