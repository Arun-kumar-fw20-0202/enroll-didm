...
const Enroll_heading = () => {
  return (
    <div>
      <div className="flex gap-2 large:text-[29px] medium:text-[25px] base:text-[24px] items-center justify-center">
        <p className="text-black">Pay Here </p>
        <p className="text-[#b64f4f]"> For The Course</p>
      </div>
